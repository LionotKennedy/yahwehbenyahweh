...
//                     <textarea
//                       value={
//                         num === 1 ? descriptionUniverse1 :
//                         num === 2 ? descriptionUniverse2 :
//                         num === 3 ? descriptionUniverse3 :
...
//                     />
//                     <button
//                       onClick={() => handleSaveDescriptionUniverse(`description${num}`, 
//                         num === 1 ? descriptionUniverse1 :
//                         num === 2 ? descriptionUniverse2 :
//                         num === 3 ? descriptionUniverse3 :
//                         descriptionUniverse4
...
//                       className="save-button description-save"
//                       disabled={!(
//                         num === 1 ? descriptionUniverse1.trim() :
//                         num === 2 ? descriptionUniverse2.trim() :
//                         num === 3 ? descriptionUniverse3.trim() :
...
//                     <textarea
//                       value={
//                         num === 1 ? descriptionCrucifixion1 :
//                         num === 2 ? descriptionCrucifixion2 :
//                         num === 3 ? descriptionCrucifixion3 :
//                         num === 4 ? descriptionCrucifixion4 :
//                         num === 5 ? descriptionCrucifixion5 :
//                         num === 6 ? descriptionCrucifixion6 :
//                         num === 7 ? descriptionCrucifixion7 :
//                         num === 8 ? descriptionCrucifixion8 :
//                         num === 9 ? descriptionCrucifixion9 :
//                         num === 10 ? descriptionCrucifixion10 :
...
//                     />
//                     <button
//                       onClick={() => handleSaveCrucifixion(`description${num}`, 
//                         num === 1 ? descriptionCrucifixion1 :
//                         num === 2 ? descriptionCrucifixion2 :
//                         num === 3 ? descriptionCrucifixion3 :
//                         num === 4 ? descriptionCrucifixion4 :
...
//                       className="save-button description-save"
//                       disabled={!(
//                         num === 1 ? descriptionCrucifixion1.trim() :
//                         num === 2 ? descriptionCrucifixion2.trim() :
//                         num === 3 ? descriptionCrucifixion3.trim() :
//                         num === 4 ? descriptionCrucifixion4.trim() :
//                         num === 5 ? descriptionCrucifixion5.trim() :
//                         num === 6 ? descriptionCrucifixion6.trim() :
//                         num === 7 ? descriptionCrucifixion7.trim() :
//                         num === 8 ? descriptionCrucifixion8.trim() :
//                         num === 9 ? descriptionCrucifixion9.trim() :
//                         num === 10 ? descriptionCrucifixion10.trim() :
...
//                     <textarea
//                       value={
//                         num === 1 ? descriptionSabbath1 :
//                         num === 2 ? descriptionSabbath2 :
//                         num === 3 ? descriptionSabbath3 :
//                         num === 4 ? descriptionSabbath4 :
//                         descriptionSabbath5
//                       }
//                       onChange={(e) => {
...
//                     />
//                     <button
//                       onClick={() => handleSaveSabbath(`description${num}`, 
//                         num === 1 ? descriptionSabbath1 :
//                         num === 2 ? descriptionSabbath2 :
//                         num === 3 ? descriptionSabbath3 :
//                         num === 4 ? descriptionSabbath4 :
...
//                       className="save-button description-save"
//                       disabled={!(
//                         num === 1 ? descriptionSabbath1.trim() :
//                         num === 2 ? descriptionSabbath2.trim() :
//                         num === 3 ? descriptionSabbath3.trim() :
//                         num === 4 ? descriptionSabbath4.trim() :
...
//                     <textarea
//                       value={
//                         num === 1 ? descriptionOperation1 :
//                         num === 2 ? descriptionOperation2 :
//                         num === 3 ? descriptionOperation3 :
...
//                     />
//                     <button
//                       onClick={() => handleSaveOperation(`description${num}`, 
//                         num === 1 ? descriptionOperation1 :
//                         num === 2 ? descriptionOperation2 :
//                         num === 3 ? descriptionOperation3 :
//                         descriptionOperation4
...
//                       className="save-button description-save"
//                       disabled={!(
//                         num === 1 ? descriptionOperation1.trim() :
//                         num === 2 ? descriptionOperation2.trim() :
//                         num === 3 ? descriptionOperation3.trim() :
...
//                     <textarea
//                       value={
//                         num === 1 ? descriptionBalance1 :
//                         num === 2 ? descriptionBalance2 :
//                         num === 3 ? descriptionBalance3 :
//                         descriptionBalance4
//                       }
//                       onChange={(e) => {
...
//                     />
//                     <button
//                       onClick={() => handleSaveBalance(`description${num}`, 
//                         num === 1 ? descriptionBalance1 :
//                         num === 2 ? descriptionBalance2 :
//                         num === 3 ? descriptionBalance3 :
//                         descriptionBalance4
...
//                       className="save-button description-save"
//                       disabled={!(
//                         num === 1 ? descriptionBalance1.trim() :
//                         num === 2 ? descriptionBalance2.trim() :
//                         num === 3 ? descriptionBalance3.trim() :
