...
const MenuTab: React.FC = () => {
  ...
  useEffect(() => {
    ...
    // Load Erosion data
    fetchData("erosion", (data) => {
      setDescriptionErosion(data.descriptionerosion || "")
    })

    // Load Operation data
    fetchData("operation", (data) => {
  ...
  const handleSaveTetragrama = async () => {
    try {
      ...
      await updateData("tetragrama", 1, data)
    } catch (error) {
  ...
  const handleSaveNation = async () => {
    try {
      ...
      await updateData("nation", 1, data)
    } catch (error) {
  ...
  const handleSaveUniverse = async () => {
    try {
      ...
      await updateData("universe", 1, data)
    } catch (error) {
  ...
  const handleSaveSabbath = async () => {
    try {
      ...
      await updateData("sabbath", 1, data)
    } catch (error) {
  ...
  const handleSaveErosion = async () => {
    try {
      ...
      await updateData("erosion", 1, data)
    } catch (error) {
  ...
  const handleSaveOperation = async () => {
    try {
      ...
      await updateData("operation", 1, data)
    } catch (error) {
  ...
  const handleSaveBalance = async () => {
    try {
      ...
      await updateData("balance", 1, data)
    } catch (error) {
