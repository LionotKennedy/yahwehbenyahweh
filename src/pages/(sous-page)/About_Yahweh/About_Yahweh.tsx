...
export function AboutYahweh() {
  return (
    <div className="about-yahweh-page">
      ...
      <div id="Yahweh_Ben_Yahweh" className="pg-btm-pd-mod">
        <img
          id="title-img"
      ...
      <div className="pg-link-text text-center py-4">
        <p className="pg-top-mrgn-mod">YAHWEH</p>
      </div>
      <div className="sec-text pg-text-fmt">
        <p className="">
          The power behind the universe is not a mysterious force, but a real
          person by the name of <span className="David">יהוה</span>. Trips to
      ...
      <div className="sec-text pg-text-fmt">
        <p className="">
          For thus saith <span className="David">יהוה</span>, that created the
          Heavens; <span className="David">יהוה</span> formed the Earth and made
      ...
      <div className="sec-text pg-text-fmt">
        <p className="">
          ...
          <span className="David">יהוה</span>, is widely acclaimed as the
      ...
      <div className="sec-text pg-text-fmt">
        <p>
          ...
          <span className="David">יהוה&nbsp;בּן&nbsp;יהוה</span>, the Son of{" "}
          <span className="David">יהוה</span>, recognized the importance of you
      ...
      <div className="sec-bar-about"></div>
      <div className="sec-text pg-text-fmt pg-text-ltr-sp-6">
        <p>
          In essence, it is absolutely impossible to enter into a relationship
          with <span className="David">יהוה</span>, without acknowledging{" "}
          <span className="David">יהוה&nbsp;בּן&nbsp;יהוה</span>, His Beloved Son
          (John 10:9, 30; John 14:6; John 17:11). Thus, to know{" "}
          <span className="David">יהוה</span>, is to experience the reality of
      ...
      <div id="pg-btm-mediad" className="py-8">
        <img
