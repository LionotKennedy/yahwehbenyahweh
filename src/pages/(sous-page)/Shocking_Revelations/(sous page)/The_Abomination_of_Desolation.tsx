    ...
    <>
      ...
      <div className="pg-title-text-shock">
        <p className="p-title-text-shock">
          NY FAHARATSIAN-TSATAKON'NY FANDRAVANA
        </p>
      </div>
        ...
        <div>
          <div>
            <div className="book-guide-shock">
              Ampahany 1 -{" "}
              <a
                href="/src/pages/(sous-page)/Shocking_Revelations/pdf/abomination_of_desolation_pt1.pdf"
                target="_blank"
              >
                Endrika Adobe PDF
              </a>
              ...
              Ampahany 2 -{" "}
              <a
                href="/src/pages/(sous-page)/Shocking_Revelations/pdf/abomination_of_desolation_pt2.pdf"
                target="_blank"
              >
                Endrika Adobe PDF
              </a>
