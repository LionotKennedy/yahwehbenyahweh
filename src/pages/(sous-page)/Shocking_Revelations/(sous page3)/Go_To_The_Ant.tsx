...
export function Go_To_The_Ant() {
  return (
    <>
      ...
      <div id="top-bar-gold-shock"></div>
      <div className="pg-title-text-shock">
        <p className="p-title-text-shock">MANDEHANA ANY AMIN'NY VITSIKA</p>
      </div>
      <div className="book-line-shock">
        <div>
          <div>
