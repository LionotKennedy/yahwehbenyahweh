...
export function The_Missionary_Spirit() {
  return (
    <>
      <div id="pg-banner-shock"></div>
      <div id="top-bar-gold-shock"></div>
      <div className="pg-title-text-shock">
        <p className="p-title-text-shock">NY FANAHIN'NY MPAZAVA VAOVAO</p>
      </div>
        ...
        <div>
          <div>
            <div className="book-guide-shock">
              Fizarana 18 -{" "}
              <a
                href="/src/pages/(sous-page)/Shocking_Revelations/pdf/missionary_spirit_pt18.pdf"
                target="_blank"
              >
                Endrika PDF Adobe
              </a>
...
export default The_Missionary_Spirit;
