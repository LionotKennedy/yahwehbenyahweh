...
export function The_Healing_Light() {
  return (
    <>
      <div id="pg-banner-shock"></div>
      <div id="top-bar-gold-shock"></div>
      <div className="pg-title-text-shock">
        <p className="p-title-text-shock">NY HAZAVANA FANASITRANANA</p>
      </div>
        ...
        <div>
          <div>
            <div className="book-guide-shock">
              Ampahany 11 -{" "}
              <a
                href="/src/pages/(sous-page)/Shocking_Revelations/pdf/healing_light_pt11.pdf"
                target="_blank"
              >
                Endrika Adobe PDF
              </a>
...
export default The_Healing_Light;
