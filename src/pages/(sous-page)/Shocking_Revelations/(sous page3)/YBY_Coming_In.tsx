...
//           יהוה בּן יהוה COMING IN THE CLOUDS OF HEAVEN WITH "POWER" AND "GREAT"
//           GLORY
//         </p>
//       </div>
...
export function YBY_Coming_In() {
  return (
    <>
      ...
      <div className="pg-title-text-shock">
        <p className="p-title-text-shock">
          יהוה בּן יהוה HAVATRA AMIN'NY RAHON'NY LANITRA MIARAKA AMIN'NY "HERY" SY NY "LEHIBE" VONINAHITRA
        </p>
      </div>
      <div className="book-line-shock">
        <div>
