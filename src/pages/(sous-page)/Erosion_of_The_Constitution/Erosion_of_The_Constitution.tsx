...
//         <p>
//           <i>“Erosion of the Constitution”</i> - was a prediction made by this
//           Website over two decades ago based on the real life events and
//           sufferings of our Messiah,{" "}
//           <span className="David-ero">יהוה&nbsp;בּן&nbsp;יהוה</span>.
//         </p>
//       </div>
//       <div className="sec-text-ero pg-text-ttl-fmt-ero">
//         <p>
//           Today, <strong>America</strong> has three{" "}
//           <strong>Classes of Citizens:</strong>
//         </p>
//       </div>
...
//                 The Political Class – to whom no laws apply;
//               </span>
//             </p>
//           </li>
//           <li>
//             <p className="p-list-margin">
//               <span className="pg-link-text-ul">
//                 The Rich – to whom no laws apply as long as they can afford to
//                 bribe the Political Class;
//               </span>
//             </p>
//           </li>
//           <li>
//             <p className="p-list-margin">
//               <span className="pg-link-text-ul">
//                 The rest of us who no longer have rights – just obligations.
//               </span>
//             </p>
//           </li>
//         </ol>
...
//           The Erosion story is a map to the Government’s best methods and
//           practices, for the re-enslavement of
//           <br />
//           <span className="pg-link-text-ul-ero">“the rest of us!”</span>
//         </p>
//       </div>
//       <div id="Truth">
...
//             alt="Erosion of The Constitution pdf document"
//           />
//         </a>
//       </div>
//       <div>
