...
//             <span className="David-nation">יהוה</span>, the Father of all men.
//             That the Holy Bible and{" "}
//             <span className="David-nation">יהוה&nbsp;בּן&nbsp;יהוה</span>
//             &nbsp;are the Great Light and the rule and guide for faith and
//             practice of the laws, statutes, judgments, and commandments of{" "}
//             <span className="David-nation">יהוה</span>, and those who believe in
//             Him and His name are immortal. Character, integrity, and morality
//             determine destiny. The love of moral men is next to love of{" "}
//             <span className="David-nation">יהוה</span>&nbsp;and His Son,{" "}
//             <span className="David-nation">יהוה&nbsp;בּן&nbsp;יהוה</span>, man’s
//             first duty. That prayer and communion of man with&nbsp;{" "}
//             <span className="David-nation">יהוה</span> is helpful.
//           </span>
//         </p>
//         <p>
//           All beliefs and tenets that make up The Nation of{" "}
//           <span className="David-nation">יהוה</span> are founded and based upon
//           the King James Version of the Bible, Old and New Testaments. The
//           Nation of <span className="David-nation">יהוה</span> is the family of{" "}
//           <span className="David-nation">יהוה</span> made up of a group of
//           persons connected by their relationship arising from a common
//           Ancestor, <span className="David-nation">יהוה</span>, The Covenant God
//           of Israel.
//         </p>
//         <p>
//           We acknowledge that all moral-minded people who agree to follow the
//           whole body of the commandments of{" "}
//           <span className="David-nation">יהוה</span> and be faithful unto His
//           Son, <span className="David-nation">יהוה&nbsp;בּן&nbsp;יהוה</span>, can
//           be joined to The Nation of <span className="David-nation">יהוה</span>.
//           We know that under this agreement, we are all sons and daughters of{" "}
//           <span className="David-nation">יהוה</span> and joint-heirs with{" "}
//           <span className="David-nation">יהוה&nbsp;בּן&nbsp;יהוה</span>.
//         </p>
//       </div>
//       <div className="sec-bar-nation pg-top-pd-mod-nation"></div>
...
//           alt="OUR MOTTO IS: ONE GOD! ONE MIND! ONE LOVE! AND ONE ACTION!"
//         />
//       </div>
//       <div className="pg-link-text-nation">
//         <p>
//           CLICK BELOW FOR MORE FACTS ABOUT
//           <br />
//           <span className="pg-link-text-ul-nation">
//             THE NATION OF <span className="David-lg-nation">יהוה</span>
//           </span>
//         </p>
//       </div>
...
//               alt="Who is the Nation of Yahweh French PDF"
...
//               alt="Who is the Nation of Yahweh Spanish PDF"
//               className="width-guide-nation"
//             />
//           </a>
//         </div>
...
//               alt=" Who is the Nation of Yahweh English PDF"
//               className="width-guide-nation"
//             />
//           </a>
//         </div>
...
//           alt="Who is the Nation of Yahweh Information"
//         />
//       </div>
