...
//       <div className={`topnav-pers ${isOpen ? "responsive" : ""}`} id="myTopnav">
//         {/* Menu button for mobile */}
//         <button className="icon-pers style-nav mobile-menu-btnX" onClick={toggleMenu} aria-label="Toggle menu">
//           {isOpen ? <X size={20} /> : <Menu size={20} />}
//         </button>
...
//           <Link to="/Contact_Us" className="nav-link-pers" onClick={() => setIsOpen(false)}>
//             <strong>CONTACT US</strong>
//           </Link>

//           <a href="https://shop.yahwehbenyahweh.com/" target="_blank" rel="noopener noreferrer" className="nav-link-pers">
//             <strong>ONLINE BOOKSTORE</strong>
//           </a>
